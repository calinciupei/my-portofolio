...
export const Html5: FunctionComponent<Html5Props> = ({ color }) => {
  const classes = classnames(styles.icon, {
    [styles.carbon]: color === Html5Color.Carbon
  });

  return (
    <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 384 512">
