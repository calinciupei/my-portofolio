...
export const Javascript: FunctionComponent<JavascriptProps> = ({ color }) => {
  const classes = classnames(styles.icon, {
    [styles.carbon]: color === JavascriptColor.Carbon
  });

  return (
    <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 448 512">
